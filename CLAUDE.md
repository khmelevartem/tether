...
- **Прежде чем писать ADR / спеку / док — прочитай все артефакты, на которые он будет ссылаться** (linked issues, соседние ADR, упомянутые доки). Без этого вывод опирается на догадку о контексте, а не на сам контекст.
- **Утверждение об улучшении (производительность, время CI, размер артефакта) требует измерения до/после.** Без чисел — это гипотеза, формулируй как гипотезу или не пиши.
