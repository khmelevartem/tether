...
| 3   | [#189](https://github.com/khmelevartem/tether/issues/189) | FileServer wire contract для folder send: sanitize пути и UploadStorage seam            | feature  | M      | ✅ in progress, считаем сделанным |
