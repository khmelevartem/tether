...
- [Transport](transport.md) — HTTP-слой между paired-нодами: engines, route surface, streaming, source-set layout, in-flight изменения. Living-doc сторона трёх ADR.
