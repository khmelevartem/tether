...
- [Glossary discipline](grilling-and-glossary.md) — `docs/glossary.md` как единый словарь (product / technical); `review-glossary` как сабагент, который ловит drift и недокументированные термины в PR-диффе.
