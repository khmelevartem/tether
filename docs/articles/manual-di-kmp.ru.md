...
С одной стороны, это можно принять за место, где ручная композиция начинает проигрывать аппарату фреймворка. Само число рабочих конфигураций задано архитектурой, и фреймворк его не убирает. Что он действительно сокращает — это объём кода: дочерние субкомпоненты собирают тот же кросс-продукт из вкладов по каждой оси, тогда как вручную пишется фрагмент на каждую комбинацию. Но реальная проблема в таком случае — в дизайне системы, и фреймворк здесь только обезболивающее, тогда как ручной DI сразу и больно её подсвечивает.
