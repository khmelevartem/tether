...
Структурный триггер добавления фреймворка по сути один — **скоупы и lifecycle-bound зависимости**. Когда графу нужно ограничение по времени жизни я ивная выгрузка из памяти.
