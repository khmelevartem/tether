# Твой ИИ-агент полюбит ручной DI в Kotlin Multiplatform
...
![Дикие фреймворки и прирученный код](tamed-cover.jpg)
...
![Композиция: AppContainer собирается из независимых фрагментов по каждой оси](composition.png)
...
![Подключение Api и Impl](api-impl.png)
...
![Каскад видимости через наследование](inheritance.png)
...
![Паттерн Provider: одно владение контейнером — несколько типизированных провайдеров](provider-pattern.png)
...
Практический разбор такой миграции на Metro в KMP-мобильном приложении — [Metro DI for KMP Mobile](https://funkymuse.dev/posts/metro-di-kmp-mobile/) FunkyMuse: стартовая точка там была не composition root, а самописный God Object, но итоговая форма (скоупы, multibindings, contributes-to) — ровно то, что разблокирует фреймворк после описанных триггеров.
