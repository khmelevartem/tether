...
Review rounds separate the bands more cleanly than the raw comment count (whose `L` distribution is right-skewed): `S` averages ~0 rounds, `M` ~1, `L` 2–3.
