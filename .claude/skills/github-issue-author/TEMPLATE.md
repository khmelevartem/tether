...
Формулировки в стиле «можно проверить да/нет». Где можно — указывай **конкретные команды** для прогона, не описания. Исполнитель должен иметь возможность скопировать и запустить.
