...
> Это **непроверенные гипотезы** автора issue. До написания PR исполнитель обязан верифицировать реальный root cause (см. `/work-on-issue` шаг root cause verification) и зафиксировать его комментарием в issue.
