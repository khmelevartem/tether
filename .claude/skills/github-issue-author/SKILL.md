...
См. [`grilling-and-glossary.md`](../../../docs/engineering/grilling-and-glossary.md). Пропускать запрещено; если глоссарий ничего не знает про доменную область issue, грилл создаст первые записи лениво.
