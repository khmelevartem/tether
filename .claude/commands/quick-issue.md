...
1. Напиши краткий черновик: заголовок + 2-4 предложения контекста + DoD-чеклист + предполагаемый `size:` (S — до 4 часов, M — до одного дня, L — до трёх дней). Покажи пользователю, жди апрува.
