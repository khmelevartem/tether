...
**Vocabulary pass.** Invoke [`grill-with-docs`](../skills/grill-with-docs/SKILL.md) on the brief. It checks every load-bearing noun against [`docs/glossary.md`](../../docs/glossary.md), writes new product terms to the Product section in the same pass, and returns drift flags. Fix any drift before handing back. This is a mount point in [`grilling-and-glossary.md`](../../docs/engineering/grilling-and-glossary.md) — UX briefs are a long-lived Product-layer artifact and inherit the same vocabulary discipline as specs and engineering docs.
